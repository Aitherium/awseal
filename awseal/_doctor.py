...
interesting failures live BETWEEN them. "awseal is installed" is not the useful
fact -- "awseal is installed and the thing it pairs with is not" is. This reports
...
SELF = 'awseal'
FAMILY = ['awask', 'awask', 'awbac', 'awbrowse', 'awdit', 'awevolve', 'awevolve', 'awfind', 'awgit', 'awgraph', 'awiam', 'awkno', 'awm', 'awmail', 'awnboard', 'awnest', 'awnet', 'awnode', 'awpredict', 'awprism', 'awreason', 'awrecover', 'awrecurse', 'awrelay', 'awrepl', 'awresearch', 'awrun', 'awshare', 'awtunnel']
PAIRS_WITH = ['awdit', 'awshare']
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awseal needs at runtime, and a
